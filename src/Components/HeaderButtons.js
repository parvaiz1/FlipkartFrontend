...
const [account, setAccount] = useContext(DataContext)
  ...
  return (
    <Box className="wrapperButtons">
      ...
      <Typography style={{ marginTop: 4, marginLeft: "40px", whiteSpace:"nowrap" }}>Become a Seller</Typography>
      <Typography style={{ marginTop: 4, marginLeft: "40px" }}>More</Typography>
      <Box style={{ display: "flex", marginTop: 4, marginLeft: "40px",cursor:"pointer" }} onClick ={()=>{navigate("/Cart")}} >
